...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'db/database.db'), # Or path to database file if using sqlite3.
...
SECRET_KEY = '*v*clbgmfamwy4o8mk3a_jvbj^fgazy^50floz56(8&)bk@ezt'
